<?php
$MESSAGE['LICENSE_OK']            = "The License Key supplied with this file is valid. If this application was not a demonstration the end user would not see this display, your application could then run as normal.<br /><br /> <a href=http://".$_SERVER['SERVER_NAME'].">Start to stream you torrents!</a>";
...
$MESSAGE['LICENSE_INVALID']       = "The License Key is invalid. This means that your License Key file has become corrupted. Please replace the file 'license.supplied.dat' with a copy of the original license. If you do not still have a copy of the original license please contact the applications reseller.<br />Add new licence<br /><br /><br /><a target='_BLANK' href='http://license.netix.stream/'>Get your Free license now</a><br /><br /><form action='?page=license' method='POST'><textarea id='licenceKey' name='licenceKey' rows='7' cols='60'></textarea><br /><br /><input type='submit' id='submit' name='submit' value='Submit'></form> ";
$MESSAGE['LICENSE_EMPTY']         = "The License Key is empty. Please make sure that the file 'license.supplied.dat' is writeable by the web server, then copy and paste the key into the box below and click submit.<br /><br /><a target='_BLANK' href='http://license.netix.stream/'>Get your Free license now</a><br /><br /><form action='?page=license' method='POST'><textarea id='licenceKey' name='licenceKey' rows='7' cols='60'></textarea><br /><br /><input type='submit' id='submit' name='submit' value='Submit'></form>";
